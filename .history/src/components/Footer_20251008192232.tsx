...
// Using a placeholder URL for the logo to resolve the file path error.
// Replace this with your actual logo import if the file exists in your project.
const vedLogo = "https://placehold.co/200x200/1a1a1a/ffffff?text=VCI&font=raleway";
...
export function Footer() {
  return (
    <footer className="bg-background overflow-hidden">
      ...
      {/* Main Footer Content */}
      <div className="relative bg-gradient-to-b from-background via-gray-50 to-background pt-20 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative z-20 flex justify-center -mt-40 mb-12">
            <motion.div
            ...
            >
                ...
                <motion.img
                    src={vedLogo}
                    alt="Ved Constructions & Infra Logo"
                    className="relative h-40 w-40 rounded-full object-cover border-4 border-white/10 shadow-2xl"
            ...
            >
              {[
                ...
                },
                {
                  icon: MapPin,
                  label: "Visit Us",
                  value: "1037 W2 Basant Vihar, Naubasta, Kanpur, Uttar Pradesh",
                  href: "#",
                },
              ].map((item, index) => (
                <motion.a
