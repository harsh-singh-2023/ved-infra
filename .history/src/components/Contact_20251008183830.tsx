...
export function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["info@vedconstructions.com"],
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-background via-gray-50/50 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            style={{
              background: "radial-gradient(circle, rgba(3, 2, 19, 0.08) 0%, transparent 70%)",
              left: `${20 + i * 30}%`,
              top: `${20 + (i % 2) * 50}%`,
            }}
            animate={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="mb-6 text-4xl md:text-5xl">We'd Love to Hear From You!</h2>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Have a project in mind or just want to say hello? We're excited to discuss how we can help bring your vision to life.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start max-w-7xl mx-auto">
              ...
              <CardContent className="p-10">
                ...
                <AnimatePresence mode="wait">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    >
                      <label className="block text-sm mb-3">Your Name *</label>
                      <Input
                    ...
                    >
                      <label className="block text-sm mb-3">Phone Number *</label>
                      <Input
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.3 }}
                  >
                    <label className="block text-sm mb-3">Email Address *</label>
                    <Input
                      type="email"
                  ...
                  >
                    ...
                    <select className="w-full h-12 px-4 py-2 bg-input-background border border-border/50 rounded-lg focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300">
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.5 }}
                  >
                    <label className="block text-sm mb-3">Tell Us About Your Project *</label>
                    <Textarea
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                  >
                    <Button size="lg" className="w-full h-14 text-lg group relative overflow-hidden">
                      <motion.div
          ...
          >
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <motion.div
                        ...
                        className="w-14 h-14 bg-gradient-to-br from-primary/20 to-primary/10 rounded-xl flex items-center justify-center flex-shrink-0 relative overflow-hidden"
                      >
                        <motion.div
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.5 }}
              className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 p-8 rounded-2xl text-center relative overflow-hidden"
            >
              <motion.div
              ...
              <motion.div
                ...
                className="w-20 h-20 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-5 relative"
              >
                <CheckCircle2 className="w-10 h-10 text-primary" />
              </motion.div>
              
              <h4 className="mb-3 text-xl">Quick Response Guaranteed!</h4>
              <p className="text-sm text-muted-foreground leading-relaxed">
                We typically respond to all inquiries within 2-4 hours during business hours. Your project matters to us!
              </p>
            </motion.div>
          </motion.div>
        </div>
